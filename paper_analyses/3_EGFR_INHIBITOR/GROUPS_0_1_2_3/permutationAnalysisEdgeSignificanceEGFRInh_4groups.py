...
def write_edge_subpopulation_differences(trueEdges, resultPermSimulations):
    ...
    dfEdgeDiff.to_csv("../bin/edgeSignificanceEGFRINH_RecoveredDifferences_4groups.tsv", sep="\t")
    ...
    truePoint.to_csv("../bin/edgeSignificanceEGFRINH_TrueDifferences_4groups.tsv", sep="\t")


egfrInhDataProcessed = pd.read_csv("../bin/EGFRInhibitionDataProcessed_4Groups.tsv",sep='\t')
