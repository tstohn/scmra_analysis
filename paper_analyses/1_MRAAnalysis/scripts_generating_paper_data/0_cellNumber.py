...
to estimate needed cell number to infer network topology

etas are chosen by firstly estimating the eta-edgeNumber function ( exponential decay)
and choosing the etas resulting in networks with edges between 1-22 (two times the real edge number), assuming
